# SolarNodeOS - IoT LINK iMX93 - Change Log

# 2026-09-01

Based on Debian 12.15, kernel 6.6.

Includes the following core SolarNode packages:

| Package                            | Version  | Description |
|:-----------------------------------|:---------|:------------|
| sn-iotlink-imx93-support           | 1.2.0-1  | IoT Link iMX93 support |
| sn-mbpoll                          | 1.5.2-1  | Command line utility to communicate with Modbus devices |
| sn-nftables                        | 1.2.1-1  | nftables firewall management service |
...
| solarnode-app-core                 | [4.12.0-1][solarnode-app-core-log] | SolarNode application core |
| solarnode-app-db-h2                | 3.0.0-1  | SolarNode DB - H2 |
| solarnode-app-io-mqtt              | 5.1.0-1  | SolarNode MQTT I/O - API |
| solarnode-app-io-mqtt-netty        | 5.1.0-1  | SolarNode MQTT I/O - Netty |
| solarnode-base                     | [5.3.0-1][solarnode-base-log] | SolarNode platform |
...
| solarnode-base-bouncy-castle       | 1.1.0-1  | SolarNode platform Bouncy Castle PKI support |
| solarnode-base-fastcsv             | 1.0.0-1  | SolarNode platform FastCSV support |
| solarnode-base-h2                  | 1.3.0-1  | SolarNode platform H2 database support |
| solarnode-base-httpclient          | 1.1.0-2  | SolarNode platform HTTP client support |
| solarnode-base-jackson             | 1.4.0-1  | SolarNode platform Jackson JSON support |
| solarnode-base-jackson-annotations | 1.0.0-1  | SolarNode platform Jackson JSON support |
| solarnode-base-jackson3            | 1.0.0-1  | SolarNode platform Jackson JSON 3 support |
| solarnode-base-java17              | 1.0.2-1  | SolarNode platform Java 17 support |
| solarnode-base-javassist           | 1.0.0-2  | SolarNode platform Javassist support |
...
| solarnode-base-log4j2              | 2.25.3-1 | SolarNode platform Log4j2 logging support |
| solarnode-base-micrometer          | 1.0.1-1  | SolarNode platform Micrometer support |
| solarnode-base-netty               | 1.2.6-1  | SolarNode platform Netty support |
| solarnode-base-ognl                | 1.0.0-1  | SolarNode platform OGNL support |
| solarnode-base-pax-web             | 1.1.0-1  | SolarNode platform Pax Web support |
...
| solarnode-base-thymeleaf           | 1.0.0-1  | SolarNode platform Apache Tiles support |
...
| Package                            | Version  | Description |
|:-----------------------------------|:---------|:------------|
| sn-iotlink-imx93-support           | 1.0.0-1  | IoT Link iMX93 support |
| sn-mbpoll                          | 1.5.2-1  | Command line utility to communicate with Modbus devices |
| sn-nftables                        | 1.2.0-1  | nftables firewall management service |
| sn-osstat                          | 1.1.0-2  | SolarNode OS statistics support |
| sn-solarpkg                        | 1.3.0-1  | SolarNode package management support |
| sn-solarssh                        | 1.0.0-4  | SolarSSH support |
| sn-system                          | 1.7.1-1  | SolarNode system support |
| sn-wifi                            | 1.4.0-2  | WiFi management service |
| solarnode-app-core                 | [4.9.0-1][solarnode-app-core-log] | SolarNode application core |
| solarnode-app-db-h2                | 3.0.0-1  | SolarNode DB - H2 |
| solarnode-app-io-mqtt              | 5.0.0-1  | SolarNode MQTT I/O - API |
| solarnode-app-io-mqtt-netty        | 5.0.0-1  | SolarNode MQTT I/O - Netty |
| solarnode-base                     | [5.3.0-1][solarnode-base-log] | SolarNode platform |
| solarnode-base-aws                 | 1.0.0-2  | SolarNode platform AWS support |
| solarnode-base-blueprint-gemini    | 4.0.0-1  | SolarNode platform Gemini Blueprint support |
| solarnode-base-bouncy-castle       | 1.1.0-1  | SolarNode platform Bouncy Castle PKI support |
...
| solarnode-base-log4j2              | 2.25.3-1 | SolarNode platform Log4j2 logging support |
| solarnode-base-micrometer          | 1.0.1-1  | SolarNode platform Micrometer support |
| solarnode-base-netty               | 1.2.5-1  | SolarNode platform Netty support |
| solarnode-base-ognl                | 1.0.0-1  | SolarNode platform OGNL support |
| solarnode-base-pax-web             | 1.1.0-1  | SolarNode platform Pax Web support |
| solarnode-base-reactive-streams    | 1.0.0-2  | SolarNode platform Reactive Streams support |
| solarnode-base-slf4j               | 2.0.17.1 | SolarNode platform Slf4j logging support |
