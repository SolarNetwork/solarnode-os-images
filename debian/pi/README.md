...
sudo ../bin/customize.sh -v -z \
	...
	-a '-a raspberrypi -b /boot/firmware -M 12 -q bookworm -m -m -w -Q -Z UTC -K conf/raspi-packages-deb12-add.txt -A conf/raspi-packages-deb12-add-late.txt -k conf/raspi-packages-deb12-keep.txt -o 172.16.159.143:3142' \
