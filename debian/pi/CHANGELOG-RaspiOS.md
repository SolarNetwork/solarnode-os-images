...
Based on the upstream RaspiOS (formerly Raspbian) `2026-04-13-raspios-bookworm-arm64-lite` image,
and is based on Debian 12.14 and the 6.12 Linux kernel. This image requires a 2GB or larger SD card.
...
| sn-pi                              | 1.2.0-2  | Raspberry Pi SolarNode support |
...
| solarnode-app-core                 | [4.48.2-1][solarnode-app-core-log] | SolarNode application core |
...
| solarnode-base-jackson3            | 1.0.0-1  | SolarNode platform Jackson JSON support |
| solarnode-base-java17              | 1.0.2-1  | SolarNode platform Java 17 support |
| solarnode-base-javaassist          | 1.0.0-2  | SolarNode platform Javassist support |
...
| solarnode-base-netty               | 1.2.4-1  | SolarNode platform Netty support |
...
| sn-system                       | 1.7.1-1  | SolarNode system support |
| sn-wifi                         | 1.4.0-2  | WiFi management service |
| solarnode-app-core              | [3.39.0-1][solarnode-app-core-log] | SolarNode application core |
...
and is based on Debian 11.11 and the 6.1 Linux kernel. This image requires a 2GB or larger SD card.
